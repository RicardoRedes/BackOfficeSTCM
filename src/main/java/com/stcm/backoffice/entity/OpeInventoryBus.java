...
public class OpeInventoryBus {
	...
	@Column(name = "col_company_service")
	public String col_company_service;
	
	@Column(name = "col_maintenance_provider")
	...
	public OpeInventoryBus(){}
	
	public OpeInventoryBus(OpeInventoryBus tmp) {
		super();
